...
public final class SimpleExample {
	...
	static class Driver implements MovingRoadUser, TickListener {
		...
		public void tick(TimeLapse timeLapse) {
			...
			//roadModel.moveTo(this, new Point(1,1), timeLapse);
			if(roadModel.getDestination(this)==null)
			{
				roadModel.moveTo(this, roadModel.getRandomPosition(rnd), timeLapse);			

			}
			Point a=roadModel.getPosition(this);
			Point b=roadModel.getDestination(this);
			...
			{
				roadModel.moveTo(this, b, timeLapse);			
