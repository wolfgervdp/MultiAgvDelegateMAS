...
public class AntAgentRenderer extends CanvasRenderer.AbstractCanvasRenderer{
    ...
    AntAgentRenderer(RoadModel rm) {
        ...
        public void renderDynamic(GC gc, ViewPort vp, long time) {
            ...
            Set<ConnectedVisualiser> setAntVisulizer= roadModel.getObjectsOfType(ConnectedVisualiser.class);

            for(ConnectedVisualiser object : setAntVisulizer){
           ...
           // synchronized (trucks) {
              //  for (final ConnectedVisualiser t : trucks) {
    ...
    public static Builder builder() {
        return new AutoValue_AntAgentRendere_Builder();
    }


        @AutoValue
        abstract static class Builder extends
                ModelBuilder.AbstractModelBuilder<AntAgentRenderer, Void> {
            ...
            @Override
            public AntAgentRenderer build(DependencyProvider dependencyProvider) {
                final RoadModel rm = dependencyProvider.get(RoadModel.class);
                return new AntAgentRenderer(rm);
            }
        }
